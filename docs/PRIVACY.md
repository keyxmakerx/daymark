...
| `VIBRATE` | Provide haptic feedback, e.g. for the breathing pacer and the daily reminder. |
...
choose via the system file picker. Once exported, a file is outside Daymark's protection — store
it somewhere safe and treat it as sensitive. Encrypted export is on the roadmap.
